...
const Header: React.FC<HeaderProps> = ({ onMenuClick, isSidebarOpen }) => {
  ...
  return (
    <header className={`fixed top-0 right-0 left-0 ${isSidebarOpen ? 'lg:left-[280px]' : 'lg:left-[80px]'} h-[72px] lg:h-[80px] px-4 sm:px-6 lg:px-8 flex items-center justify-between bg-white dark:bg-[#1A222C] border-b border-slate-200 dark:border-slate-800 z-10 transition-all duration-300 backdrop-blur-[20px] bg-white/10`}>
