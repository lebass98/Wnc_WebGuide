...
import codeSnippets from '../../data/DataDisplaySnippets.json';
    ...
    <div className="space-y-6 pb-20 font-sans">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-1">
          <ShowcaseWrapper
            title="프로필 카드"
            description="사용자 프로필 정보를 보여주는 프리미엄 카드 레이아웃입니다."
            snippet={codeSnippets.profileCard}
          >
        ...
        <div className="xl:col-span-2">
          <ShowcaseWrapper
            title="미디어 아티클 카드"
            description="대표 이미지와 함께 포스트 정보를 표현하는 반응형 가로형 카드입니다."
            snippet={codeSnippets.mediaArticle}
          >
            <div className="bg-white dark:bg-[#1A222C] rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden flex flex-col md:flex-row w-full h-full">
        ...
        <div className="xl:col-span-1">
          <ShowcaseWrapper
            title="아바타 종류"
            description="팀원이나 사용자의 프로필을 나타내는 아바타 스타일 모음입니다."
            snippet={codeSnippets.avatars}
          >
            <div className="bg-white dark:bg-[#1A222C] p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm space-y-6 w-full h-full">
        ...
        <div className="xl:col-span-2">
          <ShowcaseWrapper
            title="리스트 그룹"
            description="아이콘 정보와 액션 링크가 결합된 설정 혹은 목록 구조입니다."
            snippet={codeSnippets.listGroups}
          >
            <div className="bg-white dark:bg-[#1A222C] p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm space-y-6 w-full h-full">
              <div className="divide-y divide-slate-100 dark:divide-slate-700/60">
                ...
                <div className="flex items-center justify-between py-3.5 first:pt-0 last:pb-0 group cursor-pointer">
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 bg-slate-55 dark:bg-slate-800 text-slate-600 dark:text-slate-400 rounded-xl group-hover:bg-indigo-50 group-hover:text-indigo-600 dark:group-hover:bg-indigo-500/10 dark:group-hover:text-indigo-400 transition-colors">
