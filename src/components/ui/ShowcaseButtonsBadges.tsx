      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <div className="flex items-center gap-2 text-[13px] text-slate-500 dark:text-slate-400 mt-1">
            ...
            <span>UI 요소</span>
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#16232A] dark:text-[#FF5B04] font-medium">버튼 & 배지</span>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                <button className="px-5 py-2.5 bg-[#16232A] hover:bg-[#23343e] dark:bg-[#FF5B04] dark:hover:bg-[#e04f00] text-white rounded-xl text-xs font-bold transition-all cursor-pointer">기본 Mirage</button>
                <button className="px-5 py-2.5 bg-[#075056] hover:bg-[#09666e] text-white rounded-xl text-xs font-bold transition-all cursor-pointer">딥 시 그린</button>
            ...
            <div className="space-y-2 pt-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button className="px-5 py-2.5 border border-[#FF5B04] hover:bg-[#FF5B04]/10 text-[#FF5B04] rounded-xl text-xs font-bold transition-all cursor-pointer">오렌지 라인</button>
                <button className="px-5 py-2.5 border border-[#075056] hover:bg-[#075056]/10 text-[#075056] dark:text-emerald-400 rounded-xl text-xs font-bold transition-all cursor-pointer">그린 라인</button>
            ...
            <div className="space-y-2 pt-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button className="px-4 py-2 text-[#FF5B04] hover:bg-[#FF5B04]/10 rounded-xl text-xs font-bold transition-all cursor-pointer">오렌지 고스트</button>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <button className="px-3 py-1.5 bg-[#16232A] dark:bg-[#FF5B04] text-white rounded-lg text-[10px] font-black tracking-wider uppercase cursor-pointer">Mini</button>
                <button className="px-4 py-2 bg-[#16232A] dark:bg-[#FF5B04] text-white rounded-lg text-xs font-bold cursor-pointer">Small</button>
                <button className="px-5 py-2.5 bg-[#16232A] dark:bg-[#FF5B04] text-white rounded-xl text-xs font-bold cursor-pointer">Medium</button>
                <button className="px-7 py-3.5 bg-[#16232A] dark:bg-[#FF5B04] text-white rounded-2xl text-sm font-black tracking-wide cursor-pointer">Large Size</button>
              </div>
            </div>
            ...
            <div className="space-y-2 pt-2">
              ...
              <div className="flex flex-wrap gap-2">
                <button className="flex items-center gap-2 px-4 py-2 bg-[#16232A] hover:bg-[#23343e] dark:bg-[#FF5B04] dark:hover:bg-[#e04f00] text-white rounded-xl text-xs font-bold transition-all cursor-pointer">
            ...
            <div className="space-y-2 pt-2">
              ...
              <div>
                ...
                >
                  {isLoading ? (
                    <>
                      <Loader2 className="w-4 h-4 animate-spin text-[#FF5B04]" />
                      처리 중...
                    </>
                  ) : isSuccess ? (
                    <>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="inline-flex rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden shadow-sm">
                ...
                <button className="px-5 py-2.5 bg-[#E4EEF0] dark:bg-[#075056]/30 text-xs font-bold text-[#16232A] dark:text-[#FF5B04] border-r border-slate-200 dark:border-slate-700 cursor-pointer">이번 주</button>
        ...
        >
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-2.5 py-1 rounded-full text-xs font-bold bg-[#E4EEF0] text-[#16232A] dark:bg-[#075056]/30 dark:text-[#E4EEF0]">대시보드</span>
            ...
            <div className="space-y-2 pt-2">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-2.5 py-0.5 rounded text-[11px] font-extrabold bg-[#FF5B04] text-white">NEW</span>
                ...
                <span className="px-2.5 py-0.5 rounded text-[11px] font-extrabold bg-[#16232A] dark:bg-slate-700 text-white">99+</span>
              </div>
            </div>
