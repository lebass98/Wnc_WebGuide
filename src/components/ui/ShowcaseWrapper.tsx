...
const ShowcaseWrapper: React.FC<ShowcaseWrapperProps> = ({ title, description, snippet, children }) => {
  ...
  return (
    <div className="space-y-4 font-sans mb-[40px] w-full">
      {/* Wrapper Header: Controls Toolbar */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 bg-slate-50/50 dark:bg-slate-800/40 rounded-2xl border border-slate-100 dark:border-slate-800">
        <div>
