...
const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <div className={`bg-white dark:bg-[#1A222C] rounded-sm p-7 border border-[#E2E8F0] dark:border-[#2E3A47] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-md hover:border-[#FF5B04]/30 flex flex-col justify-between ${className}`}>
      <div>
