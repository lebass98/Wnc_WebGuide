    ...
    <section className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="self-start md:self-auto px-4 py-2 bg-slate-900 dark:bg-slate-800 text-white rounded-xl text-xs font-medium hover:bg-slate-800 transition-colors flex items-center gap-2 cursor-pointer border border-slate-700 shadow-xs"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {templatesShowcase.map((tmpl) => (
          <div
            ...
            className="group relative bg-white dark:bg-[#1A222C] rounded-3xl border border-slate-200 dark:border-slate-800 p-6 shadow-sm hover:shadow-xl dark:hover:border-indigo-500/50 transition-all duration-300 cursor-pointer overflow-hidden flex flex-col justify-between"
          >
            ...
            <div className="relative z-10 space-y-4">
              <div className="flex items-center justify-between">
                <span className="px-3 py-1 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-500/20 text-xs font-bold rounded-full">
                  {tmpl.tag}
                </span>
                <span className="text-xs font-mono text-slate-500 dark:text-slate-400 flex items-center gap-1 font-medium">
                  <Grid className="w-3.5 h-3.5 text-indigo-500" /> {tmpl.itemCount} Components Included
                </span>
              </div>
            ...
            <div className="relative z-10 pt-6 mt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-xs">
              <span className="text-slate-500 dark:text-slate-400 flex items-center gap-1 font-mono">
                <FileText className="w-3.5 h-3.5 text-indigo-500" /> Ready to Copy Code
              </span>
