...
<div class="relative isolate px-4 sm:px-6 pt-12 sm:pt-14 bg-white dark:bg-slate-950 min-h-[500px] sm:min-h-[600px] flex flex-col w-full rounded-xl overflow-hidden">
  <!-- Navbar -->
...
<body class="bg-slate-50 dark:bg-[#0F172A] p-4 sm:p-10 flex items-center justify-center min-h-screen">
  <div class="w-full max-w-5xl mx-auto">
    <div class="relative isolate px-4 sm:px-6 pt-12 sm:pt-14 bg-white dark:bg-slate-950 min-h-[500px] sm:min-h-[600px] flex flex-col w-full rounded-xl overflow-hidden shadow-sm">
      <nav class="absolute top-0 left-0 right-0 flex items-center justify-between p-4 sm:p-6 lg:px-8 z-50">
        <div class="flex items-center lg:flex-1">
          <div class="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center">
            <i data-lucide="zap" class="h-5 w-5 text-white"></i>
...
const ClassicSplitHero = () => {
  return (
    <section className="relative overflow-hidden bg-white dark:bg-slate-900 w-full px-4 sm:px-8 py-10 lg:py-24 rounded-xl">
...
<section class="relative overflow-hidden bg-white dark:bg-slate-900 w-full px-4 sm:px-8 py-10 lg:py-24 rounded-xl">
  <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
    <!-- Left: Text -->
    <div class="space-y-6 sm:space-y-8">
      <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-550 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 text-indigo-600 dark:text-indigo-400 text-[10px] sm:text-xs font-bold uppercase tracking-wider">
...
<body class="bg-slate-50 dark:bg-[#0F172A] p-4 sm:p-10 flex items-center justify-center min-h-screen">
  <div class="w-full max-w-5xl mx-auto">
    <section class="relative overflow-hidden bg-white dark:bg-slate-900 w-full px-4 sm:px-8 py-10 lg:py-24 rounded-xl shadow-sm">
      <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        <!-- Left: Text -->
        <div class="space-y-6 sm:space-y-8">
...
const CenteredElegantHero = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-slate-950 px-4 sm:px-8 py-12 sm:py-24 text-center rounded-xl">
      {/* Glow blobs */}
...
<section class="relative w-full overflow-hidden bg-slate-950 px-4 sm:px-8 py-12 sm:py-24 text-center rounded-xl">
  <!-- Glow blobs -->
  ...
  <div class="relative z-10 max-w-4xl mx-auto space-y-6 sm:space-y-10">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
      <button class="w-full sm:w-auto px-6 py-3 sm:px-10 sm:py-4 bg-white text-slate-950 rounded-2xl text-xs sm:text-sm font-bold">
        무료로 체험하기
      </button>
    </div>
...
<body class="bg-slate-900 p-4 sm:p-10 flex items-center justify-center min-h-screen">
  <div class="w-full max-w-5xl mx-auto">
    <section class="relative w-full overflow-hidden bg-slate-950 px-4 sm:px-8 py-12 sm:py-24 text-center rounded-xl shadow-lg border border-slate-800">
      <div class="absolute inset-0 opacity-20 pointer-events-none">
        <div class="absolute top-0 left-1/4 w-[250px] sm:w-[500px] h-[250px] sm:h-[500px] bg-indigo-500 rounded-full blur-[80px] sm:blur-[120px] -translate-y-1/2"></div>
        <div class="absolute bottom-0 right-1/4 w-[250px] sm:w-[500px] h-[250px] sm:h-[500px] bg-purple-500 rounded-full blur-[80px] sm:blur-[120px] translate-y-1/2"></div>
      </div>
...
const SearchOrientedHero = () => {
  return (
    <section className="relative w-full overflow-hidden bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-4 sm:p-10 lg:p-20 shadow-sm rounded-xl">
      <div className="max-w-3xl space-y-6 sm:space-y-8">
        ...
        <div className="relative flex items-center">
          ...
          <input
            type="text"
            className="block w-full pl-11 sm:pl-16 pr-24 sm:pr-32 py-4 sm:py-6 bg-slate-50 dark:bg-slate-805 border border-slate-200 dark:border-slate-700 rounded-2xl sm:rounded-3xl text-sm outline-none"
...
<section class="relative w-full overflow-hidden bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-4 sm:p-10 lg:p-20 shadow-sm rounded-xl">
  <div class="max-w-3xl space-y-6 sm:space-y-8">
    ...
    <div class="relative flex items-center">
      <div class="absolute left-4 sm:left-6 text-slate-400 pointer-events-none">
        <i data-lucide="search" class="h-5 w-5 sm:h-6 sm:w-6"></i>
      </div>
      <input
        type="text"
        class="block w-full pl-11 sm:pl-16 pr-24 sm:pr-32 py-4 sm:py-6 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl sm:rounded-3xl text-sm outline-none"
        placeholder="문서, 컴포넌트, 또는 튜토리얼 검색..."
      />
      <div class="absolute right-2 inset-y-2 flex">
        <button class="h-full px-4 sm:px-6 bg-indigo-600 text-white rounded-xl sm:rounded-2xl text-xs sm:text-sm font-bold">
          검색
        </button>
      </div>
    </div>
  </div>
  <div class="mt-10 sm:mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
    <div class="p-5 sm:p-8 bg-slate-50 dark:bg-slate-800/50 rounded-2xl sm:rounded-3xl border border-slate-100 dark:border-slate-700/50 text-left">
      <h4 class="text-sm sm:text-base lg:text-lg font-bold text-slate-900 dark:text-white mb-2">시작하기</h4>
      <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400">프로젝트를 단시간에 실행할 수 있는 필수 가이드입니다.</p>
    </div>
    <div class="p-5 sm:p-8 bg-slate-50 dark:bg-slate-800/50 rounded-2xl sm:rounded-3xl border border-slate-100 dark:border-slate-700/50 text-left">
      <h4 class="text-sm sm:text-base lg:text-lg font-bold text-slate-900 dark:text-white mb-2">API 문서</h4>
      <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400">모든 API 엔드포인트와 사용 방법을 확인하세요.</p>
    </div>
    <div class="p-5 sm:p-8 bg-slate-50 dark:bg-slate-800/50 rounded-2xl sm:rounded-3xl border border-slate-100 dark:border-slate-700/50 text-left">
      <h4 class="text-sm sm:text-base lg:text-lg font-bold text-slate-900 dark:text-white mb-2">컴포넌트</h4>
      <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400">재사용 가능한 UI 컴포넌트 라이브러리를 탐색하세요.</p>
    </div>
  </div>
</section>`,
      css: `/* 기본 Tailwind CSS 스타일링 사용으로 별도의 커스텀 클래스가 존재하지 않습니다. */`,
    ...
    <section class="relative w-full overflow-hidden bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-4 sm:p-10 lg:p-20 shadow-sm rounded-xl">
      <div class="max-w-3xl space-y-6 sm:space-y-8">
        ...
        <div class="relative flex items-center">
          ...
          <input
            type="text"
            class="block w-full pl-11 sm:pl-16 pr-24 sm:pr-32 py-4 sm:py-6 bg-slate-50 dark:bg-slate-805 border border-slate-200 dark:border-slate-700 rounded-2xl sm:rounded-3xl text-sm outline-none dark:text-white dark:bg-slate-800 dark:placeholder:text-slate-500"
            placeholder="문서, 컴포넌트, 또는 튜토리얼 검색..."
          />
          <div class="absolute right-2 inset-y-2 flex">
            <button class="h-full px-4 sm:px-6 bg-indigo-600 text-white rounded-xl sm:rounded-2xl text-xs sm:text-sm font-bold">
      ...
      <div class="mt-10 sm:mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div class="p-5 sm:p-8 bg-slate-50 dark:bg-slate-800/50 rounded-2xl sm:rounded-3xl border border-slate-100 dark:border-slate-700/50 text-left">
          <h4 class="text-sm sm:text-base lg:text-lg font-bold text-slate-900 dark:text-white mb-2">시작하기</h4>
          <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 leading-relaxed">프로젝트를 단시간에 실행할 수 있는 필수 가이드입니다.</p>
        </div>
        <div class="p-5 sm:p-8 bg-slate-50 dark:bg-slate-800/50 rounded-2xl sm:rounded-3xl border border-slate-100 dark:border-slate-700/50 text-left">
          <h4 class="text-sm sm:text-base lg:text-lg font-bold text-slate-900 dark:text-white mb-2">API 문서</h4>
          <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 leading-relaxed">모든 API 엔드포인트와 사용 방법을 확인하세요.</p>
        </div>
        <div class="p-5 sm:p-8 bg-slate-50 dark:bg-slate-800/50 rounded-2xl sm:rounded-3xl border border-slate-100 dark:border-slate-700/50 text-left">
          <h4 class="text-sm sm:text-base lg:text-lg font-bold text-slate-900 dark:text-white mb-2">컴포넌트</h4>
          <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 leading-relaxed">재사용 가능한 UI 컴포넌트 라이브러리를 탐색하세요.</p>
        </div>
      </div>
    </section>
  </div>
...
<section class="relative h-[350px] sm:h-[480px] lg:h-[560px] w-full rounded-[28px] sm:rounded-[40px] overflow-hidden group">
  <img
    src="https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&q=80&w=2070"
    alt="사무실"
  ...
  <div class="absolute inset-0 flex flex-col justify-center px-6 sm:px-12 md:px-20 max-w-4xl space-y-4 sm:space-y-6">
    <h2 class="text-2xl sm:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight">
      모든 픽셀에<br class="hidden sm:block" /> 담긴 우아함.
    </h2>
    <p class="text-xs sm:text-base lg:text-xl text-slate-200 leading-relaxed max-w-md">
      우리는 단순함과 집중의 힘을 믿습니다. 보이지 않는 곳에서 강력한 도구를 제공합니다.
    </p>
    <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
      <button class="px-5 py-2.5 sm:px-8 sm:py-4 bg-indigo-600 text-white rounded-xl sm:rounded-2xl text-xs sm:text-sm font-bold shadow-lg hover:-translate-y-1 transition-transform w-fit">
        무료 체험 시작
      </button>
      <a href="#" class="flex items-center gap-1 text-white text-xs sm:text-sm font-bold group hover:underline w-fit">
        철학 알아보기 <i data-lucide="arrow-right" class="w-4 h-4 group-hover:translate-x-1 transition-transform"></i>
      </a>
    </div>
  </div>
</section>`,
...
<body class="bg-slate-50 dark:bg-[#0F172A] p-4 sm:p-10 flex items-center justify-center min-h-screen">
  <div class="w-full max-w-5xl mx-auto">
    <section class="relative h-[350px] sm:h-[480px] lg:h-[560px] w-full rounded-[28px] sm:rounded-[40px] overflow-hidden group shadow-md">
      <img
        src="https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&q=80&w=2070"
        alt="사무실"
        class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
      />
      <div class="absolute inset-0 bg-gradient-to-r from-slate-950 via-slate-950/50 to-transparent"></div>
      <div class="absolute inset-0 flex flex-col justify-center px-6 sm:px-12 md:px-20 max-w-4xl space-y-4 sm:space-y-6 text-left">
        <h2 class="text-2xl sm:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight">
          모든 픽셀에<br class="hidden sm:block" /> 담긴 우아함.
        </h2>
        <p class="text-xs sm:text-base lg:text-xl text-slate-200 leading-relaxed max-w-md">
  ...
  return (
    <div className="space-y-12 pb-20">
      ...
      >
        <section className="relative overflow-hidden bg-white dark:bg-slate-900 w-full px-3 sm:px-8 py-6 lg:py-24 rounded-xl">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
      ...
      >
        <section className="relative w-full overflow-hidden bg-slate-950 px-4 sm:px-8 py-8 sm:py-24 text-center rounded-xl">
      ...
      >
        <section className="relative w-full overflow-hidden bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-3 sm:p-10 lg:p-20 shadow-sm rounded-xl">
