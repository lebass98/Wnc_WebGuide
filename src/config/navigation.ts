...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { key: 'boards', labelKey: 'sidebar.boards', path: '/ui/boards', badge: '2', badgeColor: 'bg-indigo-50 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-400' },
      { key: 'breadcrumbs', labelKey: 'sidebar.breadcrumbs', path: '/ui/breadcrumbs', badge: '1', badgeColor: 'bg-indigo-50 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-400' },
