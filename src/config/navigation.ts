...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    badge: '2',
    badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/30 dark:text-[#FF5B04]',
    subItems: [
      { key: 'list', labelKey: 'sidebar.taskList', path: '/tasks/list', badge: '1', badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
      { key: 'kanban', labelKey: 'sidebar.taskKanban', path: '/tasks/kanban', badge: '1', badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
    ],
  },
  {
    key: 'forms',
  ...
  },
  {
    ...
    labelKey: 'sidebar.ui',
    badge: '23',
    badgeColor: 'bg-[#E4EEF0] text-[#16232A] dark:bg-[#075056]/30 dark:text-[#FF5B04]',
    subItems: [
      { key: 'alerts', labelKey: 'sidebar.alertsModals', path: '/ui/alerts-modals', badge: '3', badgeColor: 'bg-[#E4EEF0] text-[#16232A] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
      { key: 'buttons', labelKey: 'sidebar.buttonsBadges', path: '/ui/buttons-badges', badge: '4', badgeColor: 'bg-[#E4EEF0] text-[#16232A] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
      { key: 'boxes', labelKey: 'sidebar.boxes', path: '/ui/boxes', badge: '2', badgeColor: 'bg-[#E4EEF0] text-[#16232A] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
      { key: 'boards', labelKey: 'sidebar.boards', path: '/ui/boards', badge: '2', badgeColor: 'bg-[#E4EEF0] text-[#16232A] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
      { key: 'breadcrumbs', labelKey: 'sidebar.breadcrumbs', path: '/ui/breadcrumbs', badge: '1', badgeColor: 'bg-[#E4EEF0] text-[#16232A] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
      { key: 'data-display', labelKey: 'sidebar.dataDisplay', path: '/ui/data-display', badge: '4', badgeColor: 'bg-[#E4EEF0] text-[#16232A] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
      { key: 'progress', labelKey: 'sidebar.progressNav', path: '/ui/progress-nav', badge: '4', badgeColor: 'bg-[#E4EEF0] text-[#16232A] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
      { key: 'states', labelKey: 'sidebar.statesLoaders', path: '/ui/states-loaders', badge: '2', badgeColor: 'bg-[#E4EEF0] text-[#16232A] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
      { key: 'input', labelKey: 'sidebar.input', path: '/components/input', badge: '1', badgeColor: 'bg-[#E4EEF0] text-[#16232A] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
    ],
  },
  {
    key: 'webzine',
    ...
    subItems: [
      ...
      },
      {
        ...
        badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/30 dark:text-[#FF5B04]',
        subItems: [
          { key: 'image', labelKey: 'sidebar.arteImage', path: '/webzine/arte/image', badge: '16', badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
          { key: 'link', labelKey: 'sidebar.arteLink', path: '/webzine/arte/link', badge: '10', badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
          { key: 'video', labelKey: 'sidebar.arteVideo', path: '/webzine/arte/video', badge: '4', badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
          { key: 'text', labelKey: 'sidebar.arteText', path: '/webzine/arte/text', badge: '16', badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
          { key: 'profile', labelKey: 'sidebar.arteProfile', path: '/webzine/arte/profile', badge: '9', badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
          { key: 'box', labelKey: 'sidebar.arteBox', path: '/webzine/arte/box', badge: '14', badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
          { key: 'new', labelKey: 'sidebar.arteNew', path: '/webzine/arte/new', badge: '12', badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
          { key: 'table', labelKey: 'sidebar.arteTable', path: '/webzine/arte/table', badge: '4', badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
          { key: 'notice', labelKey: 'sidebar.arteNotice', path: '/webzine/arte/notice', badge: '6', badgeColor: 'bg-[#E4EEF0] text-[#075056] dark:bg-[#075056]/20 dark:text-[#FF5B04]' },
        ],
      },
    ],
  },
