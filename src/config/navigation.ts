...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { key: 'breadcrumbs', labelKey: 'sidebar.breadcrumbs', path: '/ui/breadcrumbs', badge: '4', badgeColor: 'bg-indigo-50 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-400' },
