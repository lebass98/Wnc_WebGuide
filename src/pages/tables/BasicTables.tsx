      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <div className="flex items-center gap-2 text-[13px] text-slate-500 dark:text-slate-400 mt-1">
            ...
            <span>테이블</span>
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#16232A] dark:text-[#FF5B04] font-medium">기본 테이블</span>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-center gap-2">
                <div className="relative">
                  ...
                  <input 
                    type="text" 
                    placeholder="검색..." 
                    className="pl-9 pr-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm outline-none w-full sm:w-64 focus:border-[#FF5B04] transition-all"
                  />
                </div>
                ...
                <thead>
                  <tr className="bg-slate-50/50 dark:bg-slate-800/50">
                    <th className="px-4 py-4 w-10">
                      <input type="checkbox" className="rounded border-slate-300 text-[#FF5B04] focus:ring-[#FF5B04] w-4 h-4" />
                    </th>
                ...
                <tbody className="divide-y divide-slate-50 dark:divide-slate-800">
                  {[
                    ...
                    <tr key={i} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-colors">
                      ...
                      <td className="px-4 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-full bg-[#E4EEF0] dark:bg-[#075056]/30 text-[#16232A] dark:text-[#FF5B04] flex items-center justify-center text-[10px] font-bold shrink-0">{row.customer.avatar}</div>
                          <div>
          ...
          <div className="p-6 bg-white dark:bg-[#1A222C]">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-50 dark:divide-slate-800">
                  {[
                    { name: 'PYPL 매수', date: 'Nov 23, 01:00 PM', price: '$2,567.88', category: '금융', status: '성공', iconColor: 'bg-[#075056]', icon: 'P' },
                    ...
                    { name: 'FB 매수', date: 'Sep 09, 02:00 AM', price: '$1,445.41', category: '소셜 미디어', status: '성공', iconColor: 'bg-[#16232A]', icon: 'F' },
            ...
            <div className="p-6 border-t border-slate-50 dark:border-slate-800 flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                {[1, 2, 3, '...', 8, 9, 10].map((p, i) => (
                  <button key={i} className={`w-8 h-8 rounded-lg text-xs font-bold transition-all ${p === 1 ? 'bg-[#E4EEF0] dark:bg-[#075056]/30 text-[#16232A] dark:text-[#FF5B04]' : 'text-slate-400 dark:text-slate-500 hover:text-[#FF5B04] hover:bg-[#E4EEF0]/50'}`}>
                    {p}
                  </button>
                ))}
              </div>
