...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-12 pb-12">
      ...
      {/* Quick Launch Webzine Builder Banner with Brand Mirage Palette */}
      <div className="bg-gradient-to-r from-[#16232A] via-[#075056] to-[#FF5B04] text-white rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl border border-[#075056]/30">
        ...
        <button
          ...
          className="px-6 py-3 bg-white hover:bg-[#E4EEF0] text-[#16232A] font-bold text-xs rounded-2xl shadow-lg transition-transform hover:scale-105 shrink-0 cursor-pointer"
        >
          웹진 조립 빌더 열기
        </button>
      </div>
