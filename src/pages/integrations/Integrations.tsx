...
import integrationsSnippets from '../../data/IntegrationsSnippets.json';
...
const Integrations: React.FC<IntegrationsProps> = ({ standalone = false }) => {
  ...
  if (standalone) {
    return (
      <div className="space-y-6">
        {/* Trigger Header (only "새 연동 추가" button) */}
                    ...
                    {dropdownOpenId === item.id && (
                      <div className="absolute right-0 mt-2 w-32 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-slate-100 dark:border-slate-700 py-1 z-10 animate-in fade-in zoom-in duration-100">
                        <button 
                          ...
                          className="w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors cursor-pointer"
                        >
                          삭제하기
                        </button>
                      </div>
              ...
              <div className="px-6 py-4 border-t border-slate-50 dark:border-slate-800 flex items-center justify-between bg-slate-50/30 dark:bg-slate-800/20">
                <div className="flex items-center gap-2">
                  ...
                  <button 
                    ...
                    className="px-4 py-2 text-xs font-bold text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-white dark:hover:bg-slate-800 transition-all cursor-pointer"
                  >
                    상세 정보
                  </button>
                </div>
              ...
              <div className="bg-white dark:bg-[#1A222C] w-full max-w-[500px] rounded-2xl shadow-xl overflow-hidden animate-in fade-in zoom-in duration-200">
                <div className="p-8 pb-6 relative">
                  <button 
                    ...
                    className="absolute right-6 top-6 w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-500 transition-colors cursor-pointer"
                  >
                    <X className="w-4 h-4" />
                  </button>
                ...
                <div className="p-8 pt-6 space-y-6">
                  ...
                  <div className="flex gap-4">
                    <button 
                      onClick={() => setActiveModal('none')}
                      className="flex-1 py-3 rounded-lg border border-slate-200 hover:border-slate-300 dark:border-slate-700 dark:hover:border-slate-600 text-[13px] font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all cursor-pointer"
                    >
                      닫기
                    </button>
                    <button 
            ...
            {activeModal === 'remove' && (
              <div className="bg-white dark:bg-[#1A222C] w-full max-w-[480px] rounded-2xl shadow-xl overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                <div className="p-8 pt-6 flex justify-center gap-4">
                  <button 
                    onClick={() => setActiveModal('none')}
                    className="px-6 py-2.5 rounded-lg border border-slate-200 hover:border-slate-300 dark:border-slate-700 dark:hover:border-slate-600 text-[14px] font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all cursor-pointer"
                  >
                    아니오, 취소할게요
                  </button>
                  <button 
                    onClick={handleRemove}
                    className="px-6 py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-lg text-[14px] font-bold transition-colors cursor-pointer"
                  >
                    네, 삭제합니다
                  </button>
                </div>
  ...
  return (
    <div className="space-y-12 pb-20 font-sans">
      ...
      <ShowcaseWrapper
        ...
        description="다양한 외부 SaaS 및 서드파티 서비스를 간편하게 연동하고 설정, 관리할 수 있는 고급 대시보드 카드 뷰 레이아웃과 입력 모달 시스템입니다."
        snippet={integrationsSnippets.integrations}
      >
