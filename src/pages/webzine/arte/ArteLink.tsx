  ...
  return (
    <div className="space-y-10 pb-10 font-sans">
      ...
      <div
        ...
        <div>
          <h1
            className="text-[26px] font-bold text-slate-900 dark:text-white leading-tight">
            링크 (a 태그)
          </h1>
          <div
            className="flex items-center gap-2 text-[13px] text-slate-500 dark:text-slate-400 mt-1">
            <span>홈</span>
