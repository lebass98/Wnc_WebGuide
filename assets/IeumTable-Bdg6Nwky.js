import{j as t}from"./vendor-react-CmoVjuNX.js";import{W as l}from"./WebzineTemplatePageLayout-BFmnRi5a.js";const d=[{id:"ieum-text-temp-15",title:"회의 및 행사 개요 카드",description:"개요 타이틀, 일시/장소 리스트 및 참석자 정보(dl)를 카드 형태로 배치합니다.",html:`<div class="meeting_info row">
...
</div>`},{id:"ieum-text-temp-16",title:"조사 개요 정보 상자",description:"설문조사 등의 조사기간, 대상, 응답자수, 방법을 일목요연하게 표 형태로 정리한 영역입니다.",html:`<div class="meeting_info row meeting_info--tit">
...
<ul class="info3">
...
</div>`},{id:"ieum-text-temp-17",title:"행사 개요 및 참석자 표",description:"행사 개요와 여러 참석자 명단을 분할하여 정리한 표 구조의 카드입니다.",html:`<div class="meeting_info row">
	<p class="info1 f_bold">개요</p>
	...
	</div>`},{id:"ieum-text-temp-18",title:"조사 개요 설명 박스",description:"상단 경계선 박스 안에 조사명과 세부 리스트(기간, 대상, 방법)를 배열하는 형태입니다.",html:`<div class="explain">
...
</div>`},{id:"ieum-table-img-top-table-bottom",title:"세로 레이아웃 (이미지 상/표 하)",description:"상단에는 데이터 그래프/이미지를 배치하고 하단에는 상세 수치 표(Table)를 제공하는 복합 구성입니다.",html:`<div>
...
</div>`},{id:"ieum-table-top-caption",title:"상단 캡션 표",description:"표의 주제나 단위 정보가 표 상단에 중앙 정렬되어 표시되는 깔끔한 테이블 스타일입니다.",html:`<div>
...
</div>`}],a=()=>t.jsx(l,{title:"표",categoryName:"웹진",brandName:"이음",subcategoryName:"표",editorType:"ieum",templates:d});export{a as default};
