import{j as e}from"./vendor-react-CmoVjuNX.js";import{W as s}from"./WebzineTemplatePageLayout-BFmnRi5a.js";const a=[{id:"ieum-text-temp-19",title:"관련 링크 리스트 박스",description:"상단 경계선 박스 안에 밑줄 링크 목록을 모아두는 레이아웃입니다.",html:`<div class="explain">
...
</div>`},{id:"ieum-text-temp-20",title:"관련 링크 및 제공 출처 표시",description:"좌측에는 관련 링크 정보, 우측에는 사진 제공자나 저작자 출처를 양끝으로 배치한 레이아웃입니다.",html:`<div class="row justify_between align_end">
<div class="from_vol">
...
</div>`},{id:"ieum-text-temp-38",title:"추천 콘텐츠 목록 상자",description:"추천 타이틀 아래에 여러 추천 콘텐츠 카드가 가로로 나열되는 레이아웃입니다.",html:`<div class="recommend-box">
...
</div>`}],m=()=>e.jsx(s,{title:"링크",categoryName:"웹진",brandName:"이음",subcategoryName:"링크",editorType:"ieum",templates:a});export{m as default};
