import{j as l}from"./vendor-react-CmoVjuNX.js";import{W as t}from"./WebzineTemplatePageLayout-BFmnRi5a.js";const e=[{id:"single-no-caption",title:"1개 (캡션 없음)",description:"가장 기본적인 단일 이미지 레이아웃입니다.",html:`<div class="postboimg ta_c mt_25">
...
</div>`},{id:"single-with-caption",title:"1개 (캡션 있음)",description:"단일 이미지 아래에 설명(캡션)이 포함된 레이아웃입니다.",html:`<div class="postboimg ta_c mt_25" style="margin:0 auto">
<ul class="ul_floatkyh6">
...
</div>`},{id:"single-right-caption",title:"1개 (우측 캡션)",description:"1개 (우측 캡션) 레이아웃 템플릿입니다.",html:`<style>
...
</div>`},{id:"double-full-caption",title:"2개 (전체 캡션)",description:"2개 (전체 캡션) 레이아웃 템플릿입니다.",html:`<div class="postboimg ta_c mt_25" style="margin:0 auto">
<ul class="ul_floatkyh6">
...
</div>`},{id:"double-individual-caption",title:"2개 (개별 캡션)",description:"2개 (개별 캡션) 레이아웃 템플릿입니다.",html:`<div class="postboimg ta_c mt_25" style="margin: 0 auto;">
<ul class="ul_floatkyh6">
...
</div>`},{id:"double-no-caption",title:"2개 (캡션 없음)",description:"2개 (캡션 없음) 레이아웃 템플릿입니다.",html:`<div class="postboimg ta_c mt_25">
<ul class="ul_floatkyh6">
...
</div>`},{id:"double-vertical-full-caption",title:"2개 (위1개 아래1개 + 전체 캡션)",description:"2개 (위1개 아래1개 + 전체 캡션) 레이아웃 템플릿입니다.",html:`<div class="postboimg ta_c mt_25">
<ul class="ul_floatkyh6">
...
</div>`},{id:"triple-full-caption",title:"3개 (전체 캡션)",description:"3개 (전체 캡션) 레이아웃 템플릿입니다.",html:`<div class="postboimg ta_c mt_25" style="margin:0 auto">
<ul class="ul_floatkyh6">
<li class="n3 m_m_10" style="margin-left: 0; float: none">
...
</div>`},{id:"triple-two-images-one-caption",title:"3개 (이미지 2개 1개 캡션)",description:"3개 (이미지 2개 1개 캡션) 레이아웃 템플릿입니다.",html:`<div class="postboimg ta_c mt_5" style="margin:0 auto">
...
</div>`},{id:"triple-individual-two-lines-caption",title:"3개 (개별 캡션 및 캡션 2줄 처리)",description:"3개 (개별 캡션 및 캡션 2줄 처리) 레이아웃 템플릿입니다.",html:`<div class="postboimg ta_c mt_5" style="margin:0 auto">
<ul class="ul_floatkyh6">
...
</div>`},{id:"triple-discussion-full-caption",title:"3개 (좌담 3명 전체 캡션)",description:"3개 (좌담 3명 전체 캡션) 레이아웃 템플릿입니다.",html:`<div class="postboimg ta_c mt_25" style="margin:0 auto">
<ul class="ul_floatkyh6">
...
</div>`},{id:"triple-two-top-one-bottom-full-caption",title:"3개 (위2개 아래1개 전체 캡션)",description:"3개 (위2개 아래1개 전체 캡션) 레이아웃 템플릿입니다.",html:`<div class="postboimg ta_c mt_25" style="margin:0 auto">
<ul class="ul_floatkyh6">
...
</div>`},{id:"quad-discussion-full-caption",title:"4개 (좌담 전체 캡션)",description:"4개 (좌담 전체 캡션) 레이아웃 템플릿입니다.",html:`<div class="postboimg ta_c mt_25" style="margin:0 auto">
<ul class="ul_floatkyh6">
...
</div>`},{id:"caption-no-br",title:"이미지 캡션 br 처리 없앤 캡션",description:"이미지 캡션 br 처리 없앤 캡션 템플릿입니다.",html:`<div class="postboimg ta_c mt_25" style="margin: 0 auto;">
<ul class="ul_floatkyh6">
...
</div>`},{id:"caption-width-based-on-image-size-1",title:"이미지 크기에 따른 캡션 넓이",description:"이미지 크기에 따른 캡션 넓이 템플릿입니다.",html:`<div class="postboimg ta_c mt_25" style="">
<ul class="ul_floatkyh6">
<li class="n3 m_m_10" style="margin-left: 0; float: none; ">
...
</div>`},{id:"vertical-each-image-caption",title:"위 아래 각각 이미지 하나 캡션",description:"위 아래 각각 이미지 하나 캡션 템플릿입니다.",html:`<div class="postboimg ta_c mt_25" style="margin:0 auto">
<ul class="ul_floatkyh6">
...
</div>`}],n=()=>l.jsx(t,{title:"이미지",subcategoryName:"이미지",templates:e});export{n as default};
