import{j as e}from"./vendor-react-CmoVjuNX.js";import{W as t}from"./WebzineTemplatePageLayout-BFmnRi5a.js";const l=[{id:"guide-small-text-center-img",title:"이용안내 (작은 글씨 추가 / 이미지 가운데)",description:"이용안내 상단 설명, 가운데 정렬 이미지, 하단 작은 부연 글씨 템플릿입니다.",html:`<div class="postbox mt_25" style="align-items: center;">
...
</div>`},{id:"guide-default",title:"이용안내 (기본)",description:"기본적인 웹진 이용안내 박스 템플릿입니다.",html:`<div class="postboimg ta_c" style="margin:0 auto">
<ul class="ul_floatkyh6">
<li class="n3 m_m_10" style="margin-left: 0; float: none"><a 
...
</div>`},{id:"quote-area",title:"따옴표 영역(필자 따옴표 밖)",description:"큰 따옴표 디자인과 함께 인용구를 강조하는 템플릿입니다.",html:`<div class="posttext mt_25 f_bold__box">
...
<div class="posttext ta_r">- 구형승 작가</div>`},{id:"quote-area",title:"따옴표 영역(필자 따옴표 안에)",description:"큰 따옴표 디자인과 함께 인용구를 강조하는 템플릿입니다.",html:`<div class="posttext mt_25 f_bold__box">
존중이란 개별자로서 그 사람을 대우하고 승인한다는 의미다. 잘 쓰인 소설일수록 우리는 그 주인공을 현실 속의 인물보다 더 쉽게 하나의 인격으로 인정할 수 있다. 도스토옙스키의 소설 속 주인공들은 극도로 지질하지만, 작가의 천재성과 치열한 노력이 빚어낸 현실감 넘치는 배경과 생생한 심리 묘사는 우리가 그들을 구체적이고 개별적인, 생동감 넘치는 존재로 인식하게 한다. 우리는 그들을 한 사람의 실존적 인물처럼 여기며 존중한다.<span class="posttext ta_r"> &#8211; 『실격당한 자들을 위한 변론』 p.14.</span></div>`},{id:"qna-area",title:"qna 영역",description:"Q&A 질문과 답변을 명확하게 구분해주는 인터뷰/질의응답 템플릿입니다.",html:`<div class="posttext mt_25 qna_q">
...
</div>`},{id:"caption-two-each",title:"이미지 아래 캡션 각각 두개",description:"2개의 나란한 이미지 아래에 개별 캡션이 각각 적용된 템플릿입니다.",html:`<div class="postboimg ta_c mt_25" style="margin: 0 auto;">
<ul class="ul_floatkyh6">
...
</div>`},{id:"caption-full-and-individual-two",title:"이미지 아래 전체 캡션 개별 캡션 2개",description:"상단에 전체를 묶는 공통 캡션이 있고, 각 이미지 아래 개별 캡션이 2개 존재하는 템플릿입니다.",html:`<div class="postboimg ta_c mt_25" style="margin:0 auto">
<ul class="ul_floatkyh6">
...
</div>`},{id:"profile-one-img-three-names",title:"프로필 - 이미지 1개 이름 3개",description:"1개의 공동 프로필 사진 또는 단체 대표 이미지와 3명의 필자/참여자 이름 및 직함 템플릿입니다.",html:`<div class="posttextinin mt_25">
<dl>
...
</div>`},{id:"discussion-img-profile-below-name",title:"좌담 - 이미지 프로필 (이름 아래 이미지)",description:"좌담/토론 참석자 이름과 직함 아래에 프로필 사진이 상하 배치된 템플릿입니다.",html:`<div class="posttext mt_25 profile-flex">
...
</div>`},{id:"webtoon-toon",title:"만화",description:"웹툰/웹진 만화 컷 및 컷설명 구성 템플릿입니다.",html:`<div class="postboimg ta_c mt_25" style="margin: 0 auto;">
...
</div>`},{id:"circle-profile-photo",title:"동그라미 프로필 사진",description:"원형(Circle) 아이콘 형태 프로필 이미지와 소개 템플릿입니다.",html:`<div class="posttext mt_25 profile-flex">
<div class="profile-box">
...
<p class="profile-txt">상대방이 동의하지 않았더라도, 액션과 리액션이 오갔다는 것 자체로 의미가 발생하고 있다고 생각합니다. 파킨슨병 환자와 무용하는 프로그램을 운영하는 예술가는 항상 참여자들에게 많은 활동을 하지 못하더라도 그냥 이곳에 있는 것만으로도 충분하다고 이야기합니다. 질문자님이 3년 동안 계속 실천하고 계셨다고 하는 것에는 이런 의미가 있는 것 같습니다.</p>
</div>`},{id:"bold-text-quote-no-graybox",title:"회색박스없이 굵은 글씨 (따옴표)",description:"배경 회색 박스 없이 굵은 폰트와 따옴표 기호로 시원하게 구성된 강조 문구 템플릿입니다.",html:`<div class="posttext mt_25 f_bold">
“사실 제일 어려운 건 학교에서 한 클래스로 만나는 학생들이에요. 학교 쪽에서 저희에게 제시한 시간과 목표가 있고, 그 안에서 또 저희가 이루고자 하는 게 있어서 조율해야 하니까요. 협력 수업을 할 수 있는 교사가 있으면 요청해요. 영화 수업 시간 외에 학생들이 일상의 이야기를 서로 떠들 수 있게, 교실 안에 주기적으로 자기 경험을 공통의 경험으로 아카이빙하는 시간을 만들어 주십사 하죠. 그것을 실마리로 영화를 만드는데, 기존의 관계랑은 다른 관계들이 탄생해요. 평소에는 발언권이 높은 친구들, 활동적이고 나서서 말하고 주장하는 친구들이 주로 주목을 받잖아요. 영화 촬영할 때는 완전히 바뀌어요. 그런 친구들보다는 오히려 진중하고 말없이 해야 할 일을 천천히 해내는 친구들이 후반부로 갈수록 소중해지죠. 물론 매 순간 그렇지는 않지만, 동일인의 행동에서 다른 가치들이 발견되면서 클래스의 안에서 관계의 전복이 일어나는 거예요.”</div>`}],o=()=>e.jsx(t,{title:"새소식",subcategoryName:"새소식",templates:l});export{o as default};
